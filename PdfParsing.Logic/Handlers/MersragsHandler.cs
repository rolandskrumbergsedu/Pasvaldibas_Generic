...
{
    public class MersragsHandler : GeneralHandler
    {
        ...
        {
            { "aigars steinbergs", "Aigars Šteinbergs" },
            { "dzintars ceravs", "Dzintars Ceravs" },
            { "arija logina", "Ārija Logina" },
            { "aivars usackis", "Aivars Ušackis" },
            { "ivars indruskevics", "Ivars Indruškevičs" },
            { "ilze indruskevica", "Ilze Indruškeviča" },
            { "roberts silins", "Roberts Šiliņš" },
            { "gvido erkis", "Gvido Erķis" },

        };

        public MersragsHandler() : base(
        ...
        public string Name => "Mersrags";
        public string Prieksedetajs => "lauris karlsons";
