...
{
    public class GulbeneHandler : GeneralHandler
    {
        ...
        {
            //{ "", "" },
            { "andis caunitis", "Andis Caunītis" },
            { "andris apinitis", "Andris Apinītis" },
            { "andris vejins", "Andris Vējiņš" },
            { "gunars ciglis", "Gunārs Ciglis" },
            { "ieva grinsteine", "Ieva Grīnšteine" },
            { "intars liepins", "Intars Liepiņš" },
            { "ivars kupcs", "Ivars Kupčs" },
            { "karlis lise", "Kārlis Liše" },
            { "maris brencis", "Māris Brencis" },
            { "normunds audziss", "Normunds Audzišs" },
            { "sandra daudzina", "Sandra Daudziņa" },
            { "stanislavs gzibovskis", "Stanislavs Gžibovskis" },
            { "valtis krauklis", "Valtis Krauklis" },
            { "zintis mezitis", "Zintis Mezītis" },
            { "dzintars polaks", "Dzintars Poļaks" },
            { "normunds mazurs", "Normunds Mazūrs" },
            { "stanislavs gžibovskis", "Stanislavs Gžibovskis" }
        };

        public GulbeneHandler() : base(
        ...
        public string Name => "Gulbene";
        public string Prieksedetajs => "nikolajs stepanovs";
        ...
        {
            return s.Replace("sede ", string.Empty)
                        .Replace("gulbenes novada domes deputats", string.Empty)
                        .Replace("gulbenes novada domes ", string.Empty)
                        .Replace("Deputati", string.Empty)
                        .Replace("deputati", string.Empty)
