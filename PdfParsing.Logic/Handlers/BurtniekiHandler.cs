...
{
    public class BurtniekiHandler : GeneralHandler
    {
        ...
        {
            //{ "", "" },
            { "janis leitis", "Jānis Leitis" },
            { "liga stebere", "Līga Stebere" },
            { "igors kornejevs", "Igors Korņējevs" },
            { "karlis sedvalds", "Kārlis Sedvalds" },
            { "aleksandra locmele", "Aleksandra Ločmele" },
            { "gunars laizans", "Gunārs Laizāns" },
            { "gatis cukmacis", "Gatis Cukmacis" },
            { "raimonds indrans", "Raimonds Indrāns" },
            { "janis matisons", "Jānis Matisons" },
            { "viesturs karlivans", "Viesturs Karlivāns" },
            { "valerijs pudenko", "Valērijs Pudenko" },
            { "anrijs slaukstins", "Anrijs Šļaukstiņš" },
            { "inese gaumane", "Inese Gaumane" },
            { "karlis greiskalns", "Kārlis Greiškalns" },
        };

        public BurtniekiHandler() : base(
        ...
        public string Name => "Burtnieki";
        public string Prieksedetajs => "edvins straume";
