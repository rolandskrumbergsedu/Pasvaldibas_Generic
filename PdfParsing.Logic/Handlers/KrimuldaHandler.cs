...
{
    public class KrimuldaHandler : GeneralHandler
    {
        ...
        {
            { "aivars bunkis", "Aivars Bunķis" },
            { "arturs caucis", "Artūrs Caucis" },
            { "ingus kaulins", "Ingus Kauliņš" },
            { "janis krievins", "Jānis Krieviņš" },
            { "linards kumskis", "Linards Kumskis" },
            { "voldemars logins", "Voldemārs Logins" },
            { "martins ozolins", "Mārtiņš Ozoliņš" },
            { "juris salmins", "Juris Salmiņš" },
            { "ziedonis skrivla", "Ziedonis Skrivļa" },
            { "liene berzina", "Liene Bērziņa" },
            { "nauris bokss", "Nauris Bokšs" },
            { "janis eisaks", "Jānis Eisaks" },
            { "martins zemitis", "Mārtiņš Zemītis" },
            { "edgars gabranovs", "Edgars Gabranovs" }
        };

        public KrimuldaHandler() : base(
        ...
        public string Name => "Krimulda";
        public string Prieksedetajs => "guntars grinvalds";
