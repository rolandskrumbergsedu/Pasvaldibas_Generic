...
{
    public class CiblaHandler : GeneralHandler
    {
        ...
        {
            //{ "", "" },
            { "aleksejs ivanovs", "Aleksejs Ivanovs" },
            { "eriks astics", "Ēriks Astičs" },
            { "sarmite lescinska", "Sarmīte Leščinska" },
            { "aldistihovskis", "AldisTihovskis" },
            { "olga malavkina", "Olga Maļavkina" },
            { "aivars rikums", "Aivars Rikums" },
            { "inese birska", "Inese Birska" },
            { "viesturs rancans", "Viesturs Rancāns" }
        };

        public CiblaHandler() : base(
        ...
        public string Name => "Cibla";
        public string Prieksedetajs => "juris dombrovskis";
