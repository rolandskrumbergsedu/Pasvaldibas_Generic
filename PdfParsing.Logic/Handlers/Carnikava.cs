...
{
    public class CarnikavaHandler : GeneralHandler
    {
        ...
        private static readonly Dictionary<string, string> Deputati = new Dictionary<string, string>
        {
            ...
            { "rolands laveikis", "Rolands Laveiķis" },
            { "pjotrs spakovs", "Pjotrs Špakovs" },
            { "eva odzina", "Eva Odziņa" },
            { "roberts raimo", "Roberts Raimo" },
            { "ilze tjarve", "Ilze Tjarve" },
            { "eduards burgelis", "Eduards Burģelis" },
            { "kristaps bergmanis", "Kristaps Bergmanis" },
            { "daiga kalnberzina", "Daiga Kalnbērziņa" },
            { "arta denina", "Arta Deniņa" },
            { "sanita sudraba", "Sanita Sudraba" },
            { "karlis eidis", "Kārlis Eidis" },
            { "eduards burģelis", "Eduards Burģelis" },
            { "edgars sliede", "Edgars Sliede" },
            { "eduards bogdanovs", "Eduards Bogdanovs" },
            { "ilze vilka", "Ilze Vilka" },
        };

        public CarnikavaHandler() : base(
        ...
        public string Name => "Carnikava";
        public string Prieksedetajs => "imants krastinš";
