...
{
    public class LimbaziHandler : GeneralHandler
    {
        ...
        {
            { "vaira abele", "Vaira Ābele" },
            { "maris belaunieks", "Māris Beļaunieks" },
            { "aigars legzdins", "Aigars Legzdiņš" },
            { "inars linins", "Inārs Liniņš" },
            { "gunta ozola", "Gunta Ozola" },
            { "gundars pless", "Gundars Plešs" },
            { "taiga plitniece", "Taiga Plitniece" },
            { "agris zakulis", "Agris Zakulis" },
            { "ineta zarina", "Ineta Zariņa" },
            { "edmunds zeidmanis", "Edmunds Zeidmanis" },
            { "artis argalis", "Artis Ārgalis" },
            { "andris garklavs", "Andris Garklāvs" },
            { "ziedonis rubezis", "Ziedonis Rubezis" },
            { "andis zalaiskalns", "Andis Zaļaiskalns" },
        };

        public LimbaziHandler() : base(
        ...
        public string Name => "Limbazi";
        public string Prieksedetajs => "didzis zemmers";
