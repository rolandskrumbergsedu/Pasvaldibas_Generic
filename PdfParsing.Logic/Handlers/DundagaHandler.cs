...
{
    public class DundagaHandler : GeneralHandler
    {
        ...
        {
            //{ "", "" },
            { "gunta abaja", "Gunta Abaja-" },
            { "andra grivane", "Andra Grīvāne" },
            { "linda pavlovska", "Linda Pavlovska" },
            { "guntis pirvits", "Guntis Pirvits" },
            { "ansis roderts", "Ansis Roderts" },
            { "aldons zumbergs", "Aldons Zumbergs" },
            { "eriks berzkalns", "Ēriks Bērzkalns" },
            { "una sila", "Una Sila" },
            { "smaida šnikvalde", "Smaida Šnikvalde" }
        };

        public DundagaHandler() : base(
        ...
        public string Name => "Dundaga";
        public string Prieksedetajs => "gunars laicans";
