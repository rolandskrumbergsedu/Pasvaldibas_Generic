...
{
    public class MalpilsHandler : GeneralHandler
    {
        ...
        {
            { "linards ligeris", "Linards Ligeris" },
            { "rolands jomerts", "Rolands Jomerts" },
            { "andris apsitis", "Andris Apsītis" },
            { "valts mihelsons", "Valts Mihelsons" },
            { "solvita strausa", "Solvita Strausa" },
            { "leontina amerika", "Leontina Amerika" },
            { "mara arente", "Māra Ārente" },
            { "agnese hildebrante", "Agnese Hildebrante" },
        };

        public MalpilsHandler() : base(
        ...
        public string Name => "Malpils";
        public string Prieksedetajs => "aleksandrs lielmezs";
